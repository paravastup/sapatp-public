...
- **AI Model**: HTTP API to Ollama on Windows host (192.168.1.100:11434)
...
- `plant_selection`: "Switch to plant 1001", "Change plant"
...
- **Plant Context**: Current plant selection (default: 1001)
...
**Configuration**:
- **URL**: http://192.168.1.100:11434 (Windows host WSL bridge IP)
...
3. **Your Plant Codes**: Default plant 1001 in examples
...
CREATE TABLE stockcheck_plant (
    id INT PRIMARY KEY AUTO_INCREMENT,
    code VARCHAR(4) NOT NULL,  -- e.g., "1001"
...
# Should show: Ollama configured: http://192.168.1.100:11434 using model atp-chatbot
```
...
**Documentation**: `/mnt/d/demoproject/docs/`
