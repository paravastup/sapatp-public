...
def test_model():
    ...
    test_cases = [
        ...
        },
        {
            ...
            "prompt": "User: Context: Product 10002, UPC 00000000010002, brand BRAND_BETA, quantity 150. Question: Extract UPC\nAssistant:",
            "expected_upc": "00000000010002",
            "should_have_upc": True
        },
        {
...
def quick_interactive_test():
    ...
    queries = [
        "User: I have product 10002 with barcode 00000000010002. Extract the UPC.\nAssistant:",
