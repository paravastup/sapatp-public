    ...
    test_cases = [
        {
            ...
            'context': 'UPC: 4154191637947 for product 10002, weight: 18.85, brand: BRAND_ALPHA',
        ...
        },
        {
            ...
            'context': 'Product 40055 - UPC: 9123426666324, country of origin: ITALY, delivery quantity: 1940, plant: 1001',
            'query': "What's the product code?",
        ...
        },
        {
            ...
            'context': 'Product 10001 has UPC 6007986284147, product number: 10001, brand: BRAND_ALPHA, vendor SKU: V-39116',
            'query': "Get the EAN",
