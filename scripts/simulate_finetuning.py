...
def create_enhanced_modelfile():
    ...
    training_file = Path('/opt/app/training_data/extraction_training_15k.jsonl')
    examples = []
...
PARAMETER seed 42'''
    ...
    modelfile_path = Path('/opt/app/Modelfile.extraction-enhanced')
...
def test_with_few_shot():
    ...
    test_context = "Product 10002 has UPC 10026102100020, brand BRAND_A"
...
Response:"""
    ...
    test_prompt_path = Path('/opt/app/test_prompt.txt')
