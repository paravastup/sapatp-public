...
# Expected output:
# Ollama configured: http://192.168.1.101:11434 using model atp-chatbot
```
...
docker exec -it atp_web curl http://192.168.1.101:11434/api/tags
