...
class ProductSearchForm(forms.Form):
    ...
    plant_code = forms.ChoiceField(
        choices=[
            ('1001', 'Plant 1001 - Main Warehouse'),
...
SAP_CONFIG = {
    'ashost': os.getenv('SAP_HOST', 'erp-server.example.com'),
...
Format natural language response
    ↓
Return to user: "📦 Stock Information: Product 10001 has 1,250 units at Plant 1001"
```
...
- `plant_selection` - "Switch to plant 1001"
...
2. Plant codes are 4 digit codes (1001, 1000, etc.)
