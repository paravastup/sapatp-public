...
### Key Styles (`app-theme.css:800-911`)
...
- ✅ `chatbot/static/chatbot/css/app-theme.css` - Added notification styles (lines 800-911)
...
```python
company_domains = ['example.com', 'example.com', 'yourcompany.com']
```
